...
Hello minoJiro! in all possible programming languages

## Aim

This repository should eventually contain the famous "Hello minoJiro!" program in all the programming languages possible...
